<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="参赛类型" prop="cansaileixing">
          <el-select v-model="ruleForm.cansaileixing" placeholder="请选择参赛类型">
            <el-option
                v-for="(item,index) in cansaileixingOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="参赛类型" prop="cansaileixing">
	      <el-input v-model="ruleForm.cansaileixing"
                placeholder="参赛类型" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="参赛人员" prop="cansairenyuan">
          <el-input v-model="ruleForm.cansairenyuan" 
              placeholder="参赛人员" clearable  :readonly="ro.cansairenyuan"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="参赛人员" prop="cansairenyuan">
              <el-input v-model="ruleForm.cansairenyuan" 
                placeholder="参赛人员" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info'" label="参赛作品" prop="cansaizuopin">
          <file-upload
          tip="点击上传参赛作品"
          action="file/upload"
          :limit="1"
          :multiple="true"
          :fileUrls="ruleForm.cansaizuopin?ruleForm.cansaizuopin:''"
          @change="cansaizuopinUploadChange"
          ></file-upload>
        </el-form-item>  
        <div v-else>
          <el-form-item v-if="ruleForm.cansaizuopin" label="参赛作品" prop="cansaizuopin">
            <el-button type="text" size="small" @click="download(ruleForm.cansaizuopin)">下载</el-button>
          </el-form-item>
        </div>    
      </el-col>      
      <el-col :span="12">
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="参赛宣言" prop="cansaixuanyan">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="参赛宣言"
                  v-model="ruleForm.cansaixuanyan" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.cansaixuanyan" label="参赛宣言" prop="cansaixuanyan">
                    <span>{{ruleForm.cansaixuanyan}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.jingsaileixing = true;
          ...
          if(o=='cansaileixing'){
            this.ruleForm.cansaileixing = obj[o];
	    this.ro.cansaileixing = true;
            continue;
          }
          if(o=='cansairenyuan'){
            this.ruleForm.cansairenyuan = obj[o];
	    this.ro.cansairenyuan = true;
            continue;
          }
          if(o=='cansaizuopin'){
            this.ruleForm.cansaizuopin = obj[o];
	    this.ro.cansaizuopin = true;
            continue;
          }
          if(o=='cansaixuanyan'){
            this.ruleForm.cansaixuanyan = obj[o];
	    this.ro.cansaixuanyan = true;
            continue;
          }
          if(o=='shenqingriqi'){
    ...
    cansaizuopinUploadChange(fileUrls) {
	this.ruleForm.cansaizuopin = fileUrls;
			this.addEditUploadStyleChange()
    },
	addEditStyleChange() {
	  this.$nextTick(()=>{
